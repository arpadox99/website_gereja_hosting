...
<body>
  ...
  <div id="media">
      ...
      <div id="carousel28" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          while ($row = $cari->fetch(PDO::FETCH_ASSOC)) :
            ...
            $path_to_image = "../img/Media/" . htmlspecialchars($role) . "/" . $gambar_slider; // Menentukan path gambar di folder 
          ?>
    ...
    <div class="container mt-4" id="perjamuan kudus - PK">
      <?php
      include '../config/config.php';
      // Ambil role dari query parameter atau variabel lain
    ...
    <div class="container mt-4" id="perjamuan kasih - PKH">
      <?php
      include '../config/config.php';
      // Ambil role dari query parameter atau variabel lain
