...
<body>
    ...
    <div>
      <article>
        <p class="serv">
          ...
          Untuk itu, seluruh wanita Bethel Indonesia Jemaat God’s Grace diharapkan untuk hadir dalam setiap ibadah yang dilaksanakan setiap hari kamis, agar semakin diperlengkapi,
          semakin dimuridkan, di ajar untuk menjadi wanita-wanita yang bukan saja berdampak bagi keluarga, tetapi juga dalam pekerjaan dan di dalam pelayanan.
        </p>
      </article>
    </div><br><br>
  </div>
  ...
  <!-- footer -->
  <div>
    <footer class="link-light bg-dark" id="classIWBIfooter">
