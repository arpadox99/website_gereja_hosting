  ...
  <div>
    ...
    <div class="container pembinasektor">
      <div class="row">
        <div class="col-md-5">
          <div class="row">
            <img src="../../../img/Service/oma cory.jpg" alt="Carolina Paais" id="pembinasektor">
          </div>
        </div>
        <div class="col-md-7">
          <div class="row">
          ...
          <div class="row">
            <div class="container deskripsek">
              <p>
                <q>Bagi bapak/ibu yang bertempat tinggal di daerah Latuhalat, Eri, Amahusu, dan sekitarnya
                  dapat mengikuti ibadah di sektor ini, setiap hari Jumat jam 18.00 WIT.</q>
              </p>
            </div>
          </div>
        </div>
