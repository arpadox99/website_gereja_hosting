...
<body>
  ...
  <div>
    <div class="sektor">
      <h2 id="umum"> SEKTOR IMANUEL </h2>
    </div>
    <div class="container pembinasektor">
      <div class="row">
        <div class="col-md-5">
          <div class="row">
            <img src="../../../img/Service/ibu erny.jpg" alt="Erny Nahaklay" id="pembinasektor">
          </div>
        </div>
        <div class="col-md-7">
          <div class="row">
          ...
          <div class=" row">
            <div class="about-text">
              <h5>Pdp. Ny. Erny J. Nahaklay/Tari, Dip.Th</h5>
              <p>Pdp. Ny. Erny Julita Nahaklay/Tari, Dip.Th menikah dengan Pdt. Dr. Demianus Nahaklay, M.Th. dan memiliki dua orang anak (Hana Debora Nahaklay dan Haniel Nahaklay).
              </p>
              <p>
          ...
          <div class="row">
            <div class="SosmedSektor">
              <a target="_blank" href="https://www.facebook.com/erni.nahaklay?mibextid=LQQJ4d" class="social-button" id="HrfSosmedSketor">
                <div class="social-icon" id="IconSosmedSektor">
                  <img src="../../../img/facebook.png" alt="Facebook">
                </div>
                Erny Nahaklay
              </a>
              <a target="_blank" href="https://www.instagram.com/nahaklayerni/" class="social-button" id="HrfSosmedSketor">
                <div class="social-icon" id="IconSosmedSektor">
          ...
          <div class="row">
            <div class="container deskripsek">
              <p>
                <q>Bagi bapak/ibu yang bertempat tinggal di daerah Kudamati, Airsalobar,
                  Talake dan sekitarnya dapat mengikuti ibadah di sektor ini, setiap hari Rabu jam 18.00 WIT.</q>
              </p>
            </div>
          </div>
        </div>
