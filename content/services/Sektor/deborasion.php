        ...
        <div class="col-md-7">
          ...
          <div class=" row">
            <div class="about-text">
              ...
              <p>
                Pdt. Dr. Demianus Nahaklay, M.Th. menikah dengan Pdp. Ny. Erny J. Nahaklay/Tari dan memiliki dua orang anak (Hana Debora Nahaklay dan Haniel Nahaklay).
              </p>
              <p>
          ...
          <div class="row">
            <div class="container deskripsek">
              <p>
                <q>Bagi bapak/ibu yang bertempat tinggal di daerah Pusat Kota dan sekitarnya dapat mengikuti ibadah di sektor ini,
                  setiap hari Rabu jam 18.00 WIT.</q>
              </p>
            </div>
          </div>
        </div>
